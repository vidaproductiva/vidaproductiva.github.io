/**
 * Vida Productiva - script.js
 * Menú móvil, año dinámico y utilidades
 */
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (toggle && navLinks) {
    ...
    navLinks.querySelectorAll('a').forEach(link => {
      link.addEventListener('click', () => {
        ...
        toggle.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/></svg>`;
      });
    });
  }
  ...
  // --- Resaltar enlace activo según la página ---
